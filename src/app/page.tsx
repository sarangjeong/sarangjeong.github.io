        ...
        {isImageClicked && (
          <div className="ml-4 p-4 rounded bg-gray-800 bg-opacity-70 text-white max-w-full overflow-y-auto max-h-96">
            ...
            <p className="text-black text-md inline">
              ...
              (2024).<br /> <em>In Proceedings of the 46th Annual Conference of the Cognitive Science Society.</em> <a href="https://github.com/sarangjeong/negated-adjectives/blob/master/writing/2024_cogsci/Jeong-et-al-2024_preprint.pdf" target="_blank" rel="noopener noreferrer" className="text-slate-400 underline">[preprint]</a> <a href="https://github.com/sarangjeong/negated-adjectives/blob/master/writing/2024_cogsci/Jeong-et-al-2024_CogSci-poster.pdf" target="_blank" rel="noopener noreferrer" className="text-slate-400 underline">[poster]</a> <a href="https://github.com/sarangjeong/negated-adjectives/" target="_blank" rel="noopener noreferrer" className="text-slate-400 underline">[git]</a><br/><br/>
